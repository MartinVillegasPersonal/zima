...
def run():
    ...
    commands = [
        # Probar descarga directa con wget que maneja mejor las redirecciones de GitHub
        "wget --no-check-certificate -O /tmp/supabase.zip 'https://codeload.github.com/supabase/docker/zip/refs/heads/master' && echo 'WGET_OK' || echo 'WGET_FAIL'",
        "ls -lh /tmp/supabase.zip",
        "unzip -q /tmp/supabase.zip -d /tmp/supabase_extract && echo 'UNZIP_OK' || echo 'UNZIP_FAIL'",
